package com.brodyagiby.hopit.views;
...
import com.brodyagiby.hopit.views.trails.TrailsView;
import com.brodyagiby.hopit.views.imagelist.ImageListView;
import com.brodyagiby.hopit.views.about.AboutView;
...
public class MainLayout extends AppLayout {
    ...
    private HorizontalLayout createHeader() {
        ...
        layout.setWidthFull();
        layout.setAlignItems(FlexComponent.Alignment.CENTER);
        Image logo = new Image("images/logo.png", "Hopit logo");
        logo.setId("logo");
        layout.add(logo);
        layout.add(new H1("Hopit"));
    ...
    private List<Tab> createMenuItems() {
        MenuItemInfo[] menuItems = new MenuItemInfo[]{ //
                new MenuItemInfo("Trails", "la la-map", TrailsView.class), //
